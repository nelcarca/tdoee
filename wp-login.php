...
function login_header( $title = 'Log In', $message = '', $wp_error = '' ) {
	...
	if ( is_multisite() ) {
		...
		$login_header_url   = 'http://www.tdoee.com/';
		$login_header_title = "Regala lo que quieras, pide lo que necesites";
	}
	...
	<div id="login">
		<h1><a href="http://www.tdoee.com/" title="Regala lo que quieras, pide lo que necesites" tabindex="-1"><?php bloginfo( 'name' ); ?></a></h1>
	<?php
